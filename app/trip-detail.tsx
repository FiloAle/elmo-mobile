...
const MUSIC_DATA = [
	...
	},
	{
		...
		artist: "Daft Punk",
		addedBy: "Vale",
		cover: "https://picsum.photos/id/51/200/200",
	},
	{
		id: "3",
		...
		addedBy: "Ste",
		cover: "https://picsum.photos/id/52/200/200",
	},
	{
		id: "4",
		title: "Kids",
		artist: "MGMT",
		addedBy: "Ale",
		cover: "https://picsum.photos/id/53/200/200",
	},
	{
		id: "5",
		title: "Breezeblocks",
		artist: "alt-J",
		addedBy: "Vale",
		cover: "https://picsum.photos/id/54/200/200",
	},
];
			...
			<View key={item.id} style={styles.timelineItemWrapper}>
				...
				<View
					style={[
						...
						showActiveSegment && styles.activeBoxWrapper,
					]}
				>
					<View style={styles.rowInfo}>
						...
						<View style={styles.rightInfo}>
							{item.distance && (
								<Text style={styles.timeInfoText}>{item.distance}</Text>
							)}
							...
							<View style={styles.progressBarBg}>
								<View
									style={[
										...
										{ width: `${(nextItem.progress || 0.5) * 100}%` },
									]}
								/>
							</View>
							<View
								style={[
									...
									{ left: `${(nextItem.progress || 0.5) * 100}%` },
								]}
							>
						...
						{friendsList.length > 0
							? friendsList.slice(0, 4).map((friend: string, index: number) => (
									<View
										...
										style={[
											styles.avatarCircle,
											{ zIndex: 4 - index, marginLeft: index === 0 ? 0 : -8 },
										]}
									>
										<Image
											source={{ uri: friend }}
				...
				{ALBUM_DATA.length === 0 ? (
					<View style={{ width: "100%", alignItems: "center", marginTop: 40 }}>
						<Text style={{ color: "#A1A1AA", fontSize: 16 }}>
							No photos yet. Start capturing your trip!
						</Text>
					</View>
				) : (
					ALBUM_DATA.map((item) => (
		...
		<GestureHandlerRootView style={{ flex: 1 }}>
			<View style={styles.container}>
				...
				<View style={styles.fixedBackground}>
					<Image
						source={require("../assets/images/background_map.jpg")}
						style={styles.image}
						contentFit="cover"
					/>
								...
								{["Trip", "Cost", "Album", "Music"].map((tab) => (
									...
									>
										<Text
											style={[
												styles.pillText,
												activeTab === tab && styles.activePillText,
											]}
										>
											{tab}
										</Text>
			...
			<View style={styles.fixedFooter}>
				{activeTab === "Trip" ? (
					<TouchableOpacity
						...
						activeOpacity={0.8}
						onPress={() => router.push("/add-stop" as any)}
					>
