				...
				<View style={styles.cardsContainer}>
					...
					<View style={styles.cardWrapper}>
						<TouchableOpacity
							style={[
								styles.card,
								selectedMode === "Alone" && styles.cardActive,
							]}
							activeOpacity={0.7}
						...
						<Text
							style={[
								styles.cardLabel,
								selectedMode === "Alone" && styles.cardLabelActive,
							]}
						>
							Alone
						</Text>
					...
					<View style={styles.cardWrapper}>
						<TouchableOpacity
							style={[
								styles.card,
								selectedMode === "With others" && styles.cardActive,
							]}
							activeOpacity={0.7}
							onPress={() => handleSelect("With others")}
						>
							<Image
								source={require("../assets/images/with_others.png")}
								style={styles.cardImage}
								contentFit="cover"
							/>
						</TouchableOpacity>
						<Text
							style={[
								styles.cardLabel,
								selectedMode === "With others" && styles.cardLabelActive,
							]}
						>
							With others
						</Text>
