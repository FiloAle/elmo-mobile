...
const HISTORY_TRIPS = [
	{
		...
		city: "Lugano",
		distance: "92.1km",
		trackImage: require("../../assets/images/Percorso_Arona.jpg"),
		images: [
	...
	},
	{
		...
		city: "Varese",
		distance: "45.8km",
		trackImage: require("../../assets/images/Percorso_lecco.jpg"),
		images: [
	...
	},
	{
		...
		distance: "89.4km",
		trackImage: require("../../assets/images/Percorso_lecco.jpg"),
		images: ["https://picsum.photos/seed/trip2a/200/200"],
		friends: [
...
const UPCOMING_TRIPS = [
	{
		...
		time: "10:30",
		distance: "113.8km",
		image: require("../../assets/images/monte_bianco.jpg"),
		friends: [
			"https://picsum.photos/seed/user6/100",
			"https://picsum.photos/seed/user7/100",
			"https://picsum.photos/seed/user1/100",
...
export default function TripsScreen() {
	...
	const [currentDate, setCurrentDate] = useState(
		`${HISTORY_TRIPS[0].date.day} ${HISTORY_TRIPS[0].date.month} 2025`
	);

	const flatListRef = useRef<FlatList>(null);

	useLayoutEffect(() => {
		// Initial scroll to focus on Upcoming section (bottom)
		setTimeout(() => {
	...
	return (
		<View style={styles.container}>
			...
			<View style={{ flex: 1, position: "relative" }}>
				...
				<View style={styles.headerContainer}>
					<View style={styles.titleRow}>
						<Animated.Text style={[styles.sectionTitle, historyTitleStyle]}>
							History
						</Animated.Text>
			...
			<TouchableOpacity
				style={styles.fab}
				activeOpacity={0.8}
				onPress={() => router.push("/add-trip-selection" as any)}
			>
