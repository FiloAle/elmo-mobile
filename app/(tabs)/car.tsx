				...
				{[...Array(12)].map((_, index) => (
					<View
						...
						style={[
							...
							{
								backgroundColor:
									index < 8 ? MINT_COLOR : "rgba(255, 255, 255, 0.2)",
							},
						]}
					/>
				))}
					...
					<View style={styles.controlsGrid}>
						...
						<TouchableOpacity
							style={[
								...
								climateOn && styles.controlButtonActive,
							]}
							activeOpacity={0.8}
						...
						>
							...
							<Text
								style={
									climateOn ? styles.controlTextActive : styles.controlText
								}
							>
								Climate
							</Text>
						...
						<TouchableOpacity
							style={[
								styles.controlButton,
								emergencyOn && styles.controlButtonActive,
							]}
							activeOpacity={0.8}
						...
						>
							...
							<Text
								style={
									emergencyOn ? styles.controlTextActive : styles.controlText
								}
							>
								Emergency Lights
							</Text>
						...
						<TouchableOpacity
							style={[
								styles.controlButton,
								isLocked && styles.controlButtonActive,
							]}
							activeOpacity={0.8}
						...
						>
							...
							/>
							<Text
								style={isLocked ? styles.controlTextActive : styles.controlText}
							>
